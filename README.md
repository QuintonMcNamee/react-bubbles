...
- [ ] Explain what a token is used for.
  A token is used for authentication. Making sure not anyone can access the data.

- [ ] What steps can you take in your web apps to keep your data secure?
  Using a login and authentication token.

- [ ] Describe how web servers work.
  A client sends an HTTP request to a web server, the web server sends a request for the data, the data store sends back the data to the web server, and the web server sends an HTTP response to the client.
